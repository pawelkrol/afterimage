...
/** Factory for [[com.github.pawelkrol.Afterimage.File.Type.PNG]] instances. */
object PNG {
  ...
  /** Creates a new PNG format converter from a [[com.github.pawelkrol.Afterimage.View.Image]] picture instance.
    *
    * @param image Image object with embedded picture data and ImageJ displayer routine
    */
